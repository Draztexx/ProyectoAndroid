...
public class ActividadDificil extends AppCompatActivity implements  View.OnClickListener {

    ImageView[] imageViewArray= new ImageView[8];
    private int[] isShowingFront = {0,0,0,0,0,0,0,0};
    int[] imageResources;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_actividad_dificil);
        alerta();
        Intent intent = getIntent();
        vidas=intent.getIntExtra("Vidas", 0)+1;
    ...
    private void alerta() {
        ...
        builder.setTitle("Título del cuadro de diálogo")
                .setMessage("Te sumamos un vida extra")
